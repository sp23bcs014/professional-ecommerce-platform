    ...
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {imagePreview && <img src={imagePreview} alt="Preview" className="mt-2 w-32 h-32 object-contain border rounded" />}
        ...
        <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded font-bold hover:bg-blue-700" disabled={submitting}>{submitting ? "Adding..." : "Add Product"}</button>
      </form>
    </div>
  );
} 