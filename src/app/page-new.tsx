      ...
      <section className="relative hero-gradient min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Link href="/products" className="btn-premium text-lg px-8 py-4 inline-block">
              Explore Collection
            </Link>
            <Link href="/categories" className="glass text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/30 transition-all duration-300">
              Browse Categories
            </Link>
          </div>
